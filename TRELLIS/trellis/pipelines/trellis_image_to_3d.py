...
class TrellisImageTo3DPipeline(Pipeline):
    ...
    # def preprocess_image(self, input: Image.Image):
    #     """
    ...
    #     return self.model_transform(output)
    ...
    def encode_image(self, image: Union[torch.Tensor, list[Image.Image]]) -> torch.Tensor:
        ...
        print('image features shape:', patchtokens.shape)
        # Remove tokens 2 to 5, keep all else
        # patchtokens = torch.cat([patchtokens[:, 0:1, :], patchtokens[:, 5:, :]], dim=1)
