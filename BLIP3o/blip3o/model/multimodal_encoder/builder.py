...
from .radio.radio_encoder import RadioVisionTower
from .dino.dino_encoder import DinoVisionTower
...
def build_gen_vision_tower(vision_tower_cfg, **kwargs):
    ...
    if "radio" in vision_tower:
        return RadioVisionTower(vision_tower, vision_tower_cfg=vision_tower_cfg, **kwargs)
